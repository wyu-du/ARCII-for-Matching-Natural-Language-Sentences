...
TRAIN_PATH = 'data/quora/relation_train.txt'
VALID_PATH = 'data/quora/relation_valid.txt'
TEST_PATH = 'data/quora/relation_test.txt'
QUESTION_PATH = 'data/quora/corpus_preprocessed.txt'
WORD_EMBED='data/quora/embed_glove_d50'
model_path='checkpoints/arcii_512_128.h5'
log_path='checkpoints/log_arcii_512_128.txt'
...
# pad the docs
padded_train_texts1=pad_sequences(train_texts1, maxlen=text1_maxlen, padding='post')
padded_train_texts2=pad_sequences(train_texts2, maxlen=text2_maxlen, padding='post')
padded_valid_texts1=pad_sequences(valid_texts1, maxlen=text1_maxlen, padding='post')
padded_valid_texts2=pad_sequences(valid_texts2, maxlen=text2_maxlen, padding='post')
padded_test_texts1=pad_sequences(test_texts1, maxlen=text1_maxlen, padding='post')
padded_test_texts2=pad_sequences(test_texts2, maxlen=text1_maxlen, padding='post')
...
out=Dense(1, activation='sigmoidoid')(mlp1)
